...
3. Na pasta do Prometheus, localize o arquivo [prometheus.yml](prometheus.yml), apague todos os dados e cole as informações do arquivo [ymlconfig.txt](ymlconfig.txt).
